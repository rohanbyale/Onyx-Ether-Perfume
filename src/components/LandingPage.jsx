...
const LuxuryShowcase = () => {
  return (
    <section className="relative min-h-screen bg-[#030610] text-[#F9FAFB] overflow-hidden flex items-center py-12 lg:py-20 selection:bg-[#0052FF]">
      ...
      {/* 1. ANIMATED BACKGROUND AMBIANCE */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#0052FF]/10 blur-[120px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#0052FF]/10 blur-[120px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>

      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        
        {/* LEFT COLUMN: THE ARCHIVE (Responsive: Order 2 on mobile) */}
        <div className="order-2 lg:order-1 lg:col-span-3 space-y-10">
          <motion.div 
            whileHover={{ y: -10 }}
            className="group cursor-pointer bg-white/[0.03] backdrop-blur-md border border-white/10 p-5 rounded-2xl transition-all duration-500 hover:border-[#0052FF]/50"
          >
        ...
        {/* CENTER COLUMN: THE HERO BOTTLE (Responsive: Order 1 on mobile) */}
        <div className="order-1 lg:order-2 lg:col-span-6 flex justify-center relative">
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
            className="relative w-full max-w-[380px] lg:max-w-md aspect-[4/5]"
          >
            {/* Inner Glow behind bottle */}
            <div className="absolute inset-0 bg-[#0052FF]/20 blur-[80px] rounded-full scale-75 animate-pulse" />
            
            <div className="w-full h-full border border-white/20 rounded-3xl overflow-hidden shadow-2xl relative z-10 group">
              <img 
                src="https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&q=80&w=800" 
                className="w-full h-full object-cover brightness-90 group-hover:brightness-110 transition-all duration-1000 group-hover:scale-105"
                alt="Signature Scent"
              />
        ...
        {/* RIGHT COLUMN: NEW ARRIVALS (Responsive: Order 3 on mobile) */}
        <div className="order-3 lg:order-3 lg:col-span-3 space-y-10">
          ...
          <motion.div 
            ...
            className="group cursor-pointer bg-white/[0.03] backdrop-blur-md border border-white/10 p-5 rounded-2xl transition-all duration-500 hover:border-[#0052FF]/50"
          >
            <div className="aspect-[3/4] overflow-hidden rounded-xl relative mb-6">
              <img 
